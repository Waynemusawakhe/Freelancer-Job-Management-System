...
INSERT INTO Skills (skills_ID, freelancer_ID, skill1, skill2, skill3) 
VALUES (10, 10, 'Data Analysis', 'Pandas', 'Excel');

--POPULATE PROJECTS
INSERT INTO Project (project_ID, client_ID, freelancer_ID, manager_ID, description, budget, deadline, status) 
VALUES (1, 1, 1, 1, 'Mobile App Development', 120000, TO_DATE('2025-02-15', 'YYYY-MM-DD'), 'Active');
INSERT INTO Project (project_ID, client_ID, freelancer_ID, manager_ID, description, budget, deadline, status) 
VALUES (2, 2, 2, 2, 'Website Redesign', 75000, TO_DATE('2025-03-01', 'YYYY-MM-DD'), 'Active');
INSERT INTO Project (project_ID, client_ID, freelancer_ID, manager_ID, description, budget, deadline, status) 
VALUES (3, 3, 3, 3, 'Cloud Migration', 180000, TO_DATE('2025-04-10', 'YYYY-MM-DD'), 'Active');
INSERT INTO Project (project_ID, client_ID, freelancer_ID, manager_ID, description, budget, deadline, status) 
VALUES (4, 4, 4, 4, 'E-commerce Platform', 210000, TO_DATE('2024-11-20', 'YYYY-MM-DD'), 'Completed');
INSERT INTO Project (project_ID, client_ID, freelancer_ID, manager_ID, description, budget, deadline, status) 
...
VALUES (1, 1, 1, 1, TO_DATE('2025-01-01', 'YYYY-MM-DD'), TO_DATE('2025-02-28', 'YYYY-MM-DD'), '50% upfront, 50% on completion', 'No refund after 50% project completion');
INSERT INTO Contract (contract_ID, project_ID, client_ID, freelancer_ID, start_Date, end_Date, payment_Terms, refund_Terms) 
VALUES (2, 2, 2, 2, TO_DATE('2025-01-15', 'YYYY-MM-DD'), TO_DATE('2025-03-15', 'YYYY-MM-DD'), 'Full payment after delivery', 'Full refund if not delivered');

--SUPPORT TICKETS
INSERT INTO Support_Ticket (ticket_ID, project_ID, client_ID, freelancer_ID, submitted_Date, descriptions, status) 
VALUES (1, 1, 1, 1, TO_DATE('2025-01-10', 'YYYY-MM-DD'), 'Bug found in mobile app', 'Open');
INSERT INTO Support_Ticket (ticket_ID, project_ID, client_ID, freelancer_ID, submitted_Date, descriptions, status) 
VALUES (2, 2, 2, 2, TO_DATE('2025-02-01', 'YYYY-MM-DD'), 'Issue with website form submission', 'Resolved');
...
VALUES (1, 1, 1, TO_DATE('2025-03-01', 'YYYY-MM-DD'), 'Excellent work delivered on time.', 4.8);
INSERT INTO Rating_Review (Rating_Review_ID, project_ID, client_ID, review_date, comments, review_score) 
VALUES (2, 2, 2, TO_DATE('2025-04-01', 'YYYY-MM-DD'), 'Very creative and professional.', 4.7);

--INVOICE
INSERT INTO Invoice (invoice_ID, project_ID, issue_Date, amount_Due, payment_method) 
VALUES (1, 1, TO_DATE('2025-02-20', 'YYYY-MM-DD'), 120000, 'EFT');
INSERT INTO Invoice (invoice_ID, project_ID, issue_Date, amount_Due, payment_method) 
VALUES (2, 2, TO_DATE('2025-03-20', 'YYYY-MM-DD'), 75000, 'Card Payment');

--PAYMENTS
INSERT INTO Payment (payment_ID, invoice_ID, officer_ID, amount, payment_Date, status) 
VALUES (1, 1, 1, 120000, TO_DATE('2025-03-01', 'YYYY-MM-DD'), 'Completed');
INSERT INTO Payment (payment_ID, invoice_ID, officer_ID, amount, payment_Date, status) 
VALUES (2, 2, 2, 75000, TO_DATE('2025-04-01', 'YYYY-MM-DD'), 'Completed');
